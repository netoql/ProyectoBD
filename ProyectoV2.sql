...
nombreTratamiento VARCHAR2(6) NOT NULL,
...
idOdoTrat NUMERIC,
cedulaOdont CHAR(10) NOT NULL,
nombreTratamiento VARCHAR2(6) NOT NULL,--CHECAR
...
CONSTRAINT FK_TRATAMIENTO_AFILIADO_HIST FOREIGN KEY(idCedula,idHist) REFERENCES HISTORIAL ON DELETE CASCADE,
CONSTRAINT CK_TRATAMIENTO_ENDED CHECK (finalizado IN ('s','n'))
);

CREATE TABLE TRATAMIENTO_SUCURSAL(
nombreTratamiento VARCHAR2(6),
nombreSuc VARCHAR2(20),
...
idHist CHAR(10)  NOT NULL,
idCedula CHAR(10) NOT NULL,
nombreSuc VARCHAR2(20)  NOT NULL,
cedulaOdont CHAR(10) NOT NULL,
fechaCita DATE NOT NULL,
numConsultorio NUMERIC(3) NOT NULL,
finalizadoCita CHAR(1) NOT NULL,
CONSTRAINT FK_CITA_HITS FOREIGN KEY (idCedula,idHist) REFERENCES HISTORIAL ON DELETE CASCADE,
